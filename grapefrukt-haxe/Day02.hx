class Day02 {
   ...
   static var data:String = "5806	6444	1281	38	267	1835	223	4912	5995	230	4395	2986	6048	4719	216	1201
...
128	2088	3422	111	3312	740	3024	1946	920	131	112	477	3386	2392	1108	2741";
    ...
    static function day02(){
		...
		for (row in rows) {
            var cells = row.split('\t');
        	var min = 0xffffff; // big value
        	var max = 0; // small value
        	for (cell in cells) {
                var value = Std.parseInt(cell);
