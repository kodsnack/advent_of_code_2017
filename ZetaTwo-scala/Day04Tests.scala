...
class Day04Tests extends FunSuite {
  test("Day04.validatepassword") {
    assert(Day04.validatepassword("aa bb cc dd ee"))
    assert(!Day04.validatepassword("aa bb cc dd aa"))
    assert(Day04.validatepassword("aa bb cc dd aaa"))
  }

  test("Day04.validatepassword2") {
    assert(Day04.validatepassword2("abcde fghij"))
    assert(!Day04.validatepassword2("abcde xyz ecdab"))
    assert(Day04.validatepassword2("a ab abc abd abf abj"))
    assert(Day04.validatepassword2("iiii oiii ooii oooi oooo"))
    assert(!Day04.validatepassword2("oiii ioii iioi iiio"))
  }
