...
import com.zetatwo.Day08.Statement
import org.scalatest.FunSuite

class Day08Tests extends FunSuite {
  ...
  test("Day08.parse") {
    assert(Day08.parse(testinput) == List(
      Statement("b", 5, "a", ">", 1),
      Statement("a", 1, "b", "<", 5),
      Statement("c", 10, "a", ">=", 1),
      Statement("c", -20, "c", "==", 10)
  ...
  test("Day08.run") {
    assert(Day08.run(testinput) == (1, 10))
  }
  ...
  test("Day08.challenge") {
    assert(Day08.run(challengeinput) == (4902, 7037))
  }
}
